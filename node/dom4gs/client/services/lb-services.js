  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "restartGame": {
          url: urlBase + "/games/restartGame",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Game#startGame
         * @methodOf lbServices.Game
         *
         * @description
         *
         ...
         */
        "startGame": {
          url: urlBase + "/games/startGame",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Game#stopGame
         * @methodOf lbServices.Game
         *
         * @description
         *
         ...
         */
        "stopGame": {
          url: urlBase + "/games/stopGame",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Game#status
         * @methodOf lbServices.Game
         *
         * @description
         *
         ...
         */
        "status": {
          url: urlBase + "/games/status",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Game#getName
         * @methodOf lbServices.Game
         *
         * @description
         *
         ...
         */
        "getName": {
          url: urlBase + "/games/getname",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Game#getId
         * @methodOf lbServices.Game
         *
         * @description
         *
